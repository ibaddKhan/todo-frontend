...
function App() {
  let [arrData, setArr] = useState(null);
  const [inputValue, setInputValue] = useState(''); // Step  1: Add state to manage input value
  ...
  const handleSubmit = (event) => { 
    ...
    axios.post("https://long-teal-tunic.cyclic.app/", { title: inputValue }) 
      .then((res) => {
        console.log(res.data);
        setArr(res.data);
      })
  ...
  return (
    <>
      ...
      <div className='flex justify-center mt-20'>
        <form onSubmit={handleSubmit}> {/* Wrap your input and button in a form */}
